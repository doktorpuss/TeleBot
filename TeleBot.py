...
from MainConversation import main_menu_conv_handler  # Import the new main menu handler
...
if __name__ == '__main__':
    ...
    # This should be added FIRST to have priority
    app.add_handler(main_menu_conv_handler)  # command : /start (Main Menu)
    
    # ==================== COMMAND HANDLERS ====================
    # Quick access commands (still available for advanced users)
    ...
    app.add_handler(CommandHandler('register',finman.registration))
    app.add_handler(CommandHandler('update_registration_mode',finman.registration_allow_update))
    app.add_handler(CommandHandler('budget_info',finman.ask_budget_balance_handler))
    app.add_handler(CommandHandler('wallet_info',finman.ask_wallet_balance_handler))
    app.add_handler(CommandHandler('wishlist_info',finman.ask_wishlist_handler))
    
    # ==================== CONVERSATION HANDLERS ====================
    # Existing conversation handlers for specific tasks
